...
$$f$$ is the population density of one of the two strains and is a function of space $$\vec{x}$$ and time $$t$$. The population, due to the wiggling of *E. coli*, diffuses with a diffusion constant $$D$$ and grows at a rate specified by $$s$$. Due to overcrowding, the population saturates at a density of $$f=1$$. The final term is the most interesting and describes how *stochasticity* impacts the evolution of the colony. $$N$$ describes how many cells locally compete at the front of a colony, and $$\zeta(\vec{x},t)$$ is Gaussian white noise with mean zero and variance 1 and is distributed over space with the property that 
...
This seemingly small change can *dramatically* alter the evolutionary dynamics of growing colonies; I explore this in the paper I am writing with Severine. 
